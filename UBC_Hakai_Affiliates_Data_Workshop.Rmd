...
ggplot()+ theme_bw()+
  ...
  scalebar(BC.df, dist = 3, dist_unit = "km", st.size=4, height=0.01, transform = TRUE, model = 'WGS84', anchor = c(x = -127.96, y = 51.63))+
...
fig1 <- ggplot()+ theme_bw()+
  ...
  scalebar(CC.df, dist = 5, dist_unit = "km", st.size=3.5, height=0.014, transform = TRUE, model = 'WGS84', anchor = c(x = -128.33, y = 51.64))+
